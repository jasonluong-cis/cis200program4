...
namespace LibraryItems
{
    public abstract class LibraryItem : IComparable<LibraryItem>
    {
        ...
        // Precondition: Has to have LibraryItem : IComparable<LibraryItem>
        // Postcondition: Compares items to each other by their titles and sorts them ascending in the sort method
